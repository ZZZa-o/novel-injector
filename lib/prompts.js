...
22. changed_facts 中本次新记录或正文被改写的事实必须填写 source_floor；它必须取自 <current> 中标出的【第 X 楼】，并选择最早明确成立该事实的实际对话楼层。不得使用自动总结所在楼层、偏差分析触发楼层、本次分析范围结束楼层或推测楼层。原样保留的旧事实不要改写其来源楼层。
